...
- [ ] Реализовать авторизацию и права доступа: аккаунты с владельцами статей либо секретные edit-token/ссылки для редактирования.
- [ ] Закрыть неавторизованное изменение и удаление статей и файлов.
